...
const firebaseConfig = {
  apiKey: "AIzaSyBki3YaOWCVi9CXuNL4GXHSjMfrOXrrqvQ", //process.env.REACT_APP_API_KEY,
  authDomain: "netflixgpt-dc87a.firebaseapp.com",// process.env.REACT_APP_AUTH_DOMAIN,
